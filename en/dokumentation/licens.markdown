...
[**Alt. 2**: When using the API-content in products or services developed by you, you are not entitled to refer to the API or to [*Name*]’s trade name or trademark]
